...
The committed baseline captures were rendered for PR #576 from commit
...
The source revision that produced this gallery passed all 683 mobile tests and
seven explicit capture cases. Final formatting and analyzer validation are
recorded in the PR checks. Coverage includes exact accepted IDs, neutral
fallbacks, authoritative command guards and impression visibility. Event images
keep independent accessibility descriptions in the clipped detail viewport.
...
gameplay state or the accessible controls.
