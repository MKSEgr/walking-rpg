...
class HomeControllerTest {
    ...
    void shouldReturnProductionHomeSnapshot() throws Exception {
        mockMvc.perform(get("/api/v1/home")
                ...
                .andExpect(jsonPath("$.weeklyActivityRhythm.activeDays")
                        .value(3))
                .andExpect(jsonPath("$.weeklyActivityRhythm.windowDays")
                        .value(7))
                .andExpect(jsonPath("$.weeklyActivityRhythm.targetActiveDays")
                        .value(4))
