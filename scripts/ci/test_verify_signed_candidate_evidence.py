...
class SignedCandidateTest(unittest.TestCase):
    ...
    def test_account_not_ready_can_remain_blocked(self) -> None:
        ...
        data = recorded(False); data["platforms"][1].update({"status": "BLOCKED", "artifactSha256": None, "verifierReceiptSha256": None, "publicCertificateFingerprintSha256": None, "signatureVerified": False, "installableByInternalAudience": False, "nextActionDueAtUtc": "2026-09-10T10:00:00Z", "blockerCategory": "account_not_ready"}); data["source"]["accountReadinessSha256"] = hashlib.sha256(blocked_bytes).hexdigest()
